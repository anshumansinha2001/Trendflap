  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center h-[85vh] bg-gradient-to-r from-gray-50 to-gray-100 text-center px-4">
        {/* 404 Number */}
        <h1 className="text-7xl md:text-9xl font-bold text-blue-500">404</h1>
        ...
        <Link
          href="/"
          className="mt-8 px-6 py-3 bg-blue-500 text-white rounded-lg shadow hover:bg-blue-700 transition"
        >
          ← Return Home
        </Link>
      </div>
